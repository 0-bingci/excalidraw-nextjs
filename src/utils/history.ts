...
// import { addOperationLog,getOperationLogs,clearOperationLogs } from "@/utils/indexedDB";
...
export interface RedoState {
  actions: HistoryAction[]; // 重做栈
  currentIndex: number; // 当前重做索引（-1 表示无操作）
}
...
let redoState: RedoState = { actions: [], currentIndex: -1 };
